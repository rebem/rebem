...
// hack to mute React warnings about "Don't set .props.className of the React component"
const origCheckAndWarnForMutatedProps = ReactElementValidator.checkAndWarnForMutatedProps;

ReactElementValidator.checkAndWarnForMutatedProps = function(element) {
    const newElement = Object.create(element);

    delete newElement.props.className;

    origCheckAndWarnForMutatedProps.call(this, newElement);
};
